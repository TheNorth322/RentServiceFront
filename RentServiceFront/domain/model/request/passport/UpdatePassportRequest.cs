...
public class UpdatePassportRequest
{
    ...
    [JsonProperty("migrationServiceId")] public long MigrationServiceId { get; set; }

    [JsonProperty("number")] public string Number { get; set; }

    [JsonProperty("series")] public string Series { get; set; }

    [JsonProperty("placeOfBirth")] public CreateAddressRequest PlaceOfBirth { get; set; }

    [JsonProperty("gender")] public Gender Gender { get; }

    public UpdatePassportRequest(long id, string username, string firstName, string lastName, string? surname,
        DateTime dateOfBirth,
        DateTime dateOfIssue, long migrationServiceId, string number, string series, CreateAddressRequest placeOfBirth,
        Gender gender)
    {
        Id = id;
        Username = username;
